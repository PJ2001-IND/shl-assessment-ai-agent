...
# ── Retrieval ──────────────────────────────────────────────────────────────
SIMILARITY_TOP_K: int = 12          # Fetch top 12 candidates for max recall
MAX_RECOMMENDATIONS: int = 10       # Hard cap per API spec
MIN_RECOMMENDATIONS: int = 1

# ── Conversation ───────────────────────────────────────────────────────────
MAX_TURNS: int = 8                  # Hard cap from assignment (evaluator caps at 8 turns)
...
LLM_TIMEOUT_SECONDS: float = 28.0   # Leave 2.0s buffer for grader's hard network cutoff
