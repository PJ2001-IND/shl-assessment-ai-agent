...
1. Semantic search over FAISS — retrieves candidates by cosine similarity
2. Metadata filter — narrows by job level, language, and test type if the user specified constraints
3. LLM selection — up to 15 prioritized results are injected into the prompt; the LLM picks the final 1–10
